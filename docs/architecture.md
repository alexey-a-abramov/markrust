...
| Layer | Engine | When |
|---|---|---|
| Document structure + source spans | comrak (same options as HTML export: GFM + footnotes + description lists) | Every edit, background thread |
